...
export function activityCounter(
  ...
  let activityID = account.concat("-").concat(intervalID.toString());
  if (marketID) {
...
export const WETH_GATEWAY_ADDRESS =
  "0xab46a03d8B82F6f8551d05FfA5E071cAfB313e5D".toLowerCase();
